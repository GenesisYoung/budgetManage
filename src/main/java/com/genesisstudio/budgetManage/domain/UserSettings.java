...
public class UserSettings implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAcountId() == null ? other.getAcountId() == null : this.getAcountId().equals(other.getAcountId()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAcountId() == null) ? 0 : getAcountId().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", acountId=").append(acountId);
